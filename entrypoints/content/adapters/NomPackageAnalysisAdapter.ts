        ...
        return [
            {
                ...
                icon: '<img width="16" height="16" src="https://npmtrends.com/images/logos/npm_trends_logo.png" />',
            },
            {
                title: 'Npm View',
                name: 'npmView',
                ...
                icon: `<img width="16" height="16" src="${npmImage}" />`,
            },
            {
                ...
                icon: '<img width="16" height="16" src="https://packagephobia.com/favicon-16x16.png" />',
            },
            {
                title: 'Npm Graph',
                name: 'npmgraph',
                ...
                icon: '<img width="16" height="16" src="https://npmgraph.js.org/favicon.1b75a10a.png" />',
            },
            {
                title: 'Bundlephobia',
                name: 'bundlephobia',
                ...
                icon: '<img width="16" height="16" src="https://bundlephobia.com/favicon-16x16.png?l=3" />',
            },
            {
                title: 'Npm Charts',
                name: 'npmcharts',
                ...
                icon: '<img width="16" height="16" src="https://npmcharts.com/favicon-16x16.png" />',
            },
            {
                title: 'Npm Stats',
                name: 'npmStat',
                ...
                icon: '<img width="16" height="16" src="https://npm-stat.com/favicon.ico" />',
            },
            {
                title: 'Moiva',
                name: 'moiva',
                ...
                icon: '<img width="16" height="16" src="https://moiva.io/favicon/favicon-16x16.png?v=lkvYMB9erB" />',
            },
            {
                title: 'RunKit',
                name: 'runKit',
                ...
                icon: '<img width="16" height="16" src="https://npm.runkit.com/apple-touch-icon-120x120-precomposed.png" />',
            },
        ].map((item) => {
            return {
                ...item,
